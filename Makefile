...
shiftlocks_p500.prg : macrodef.inc gamerule.inc playeras.inc main.asm p500/header.inc
...
shiftlocks_c64.prg : macrodef.inc gamerule.inc playeras.inc main.asm c64/header.inc
	rm -f header.inc; ln -s c64/header.inc; 64tass -a header.inc main.asm --verbose-list -L shiftlocks_c64.lst -o shiftlocks_c64.prg

shiftlocks_c16.prg : macrodef.inc gamerule.inc playeras.inc main.asm c16/header.inc
